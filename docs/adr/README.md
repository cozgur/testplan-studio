...
| ADR | Decision |
|---|---|
| [0001](0001-static-site-bring-your-own-key.md) | A static site with bring-your-own-key, not a hosted backend |
| [0002](0002-allowlisted-targets.md) | Generated specs run only against allowlisted targets |
